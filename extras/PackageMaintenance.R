...
styler::style_pkg()
OhdsiRTools::checkUsagePackage("PhenotypeSymptoms")
...
# Create manual -----------------------------------------------------------------------------
shell("rm extras/PhenotypeSymptoms.pdf")
shell("R CMD Rd2pdf ./ --output=extras/PhenotypeSymptoms.pdf")

# Store environment in which the study was executed -----------------------
OhdsiRTools::createRenvLockFile(
  rootPackage = "PhenotypeSymptoms",
  mode = "description",
